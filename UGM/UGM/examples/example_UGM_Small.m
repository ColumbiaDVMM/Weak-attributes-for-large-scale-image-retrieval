...
neighbors_n = edgeStruct.E(edgeStruct.V(n):edgeStruct.V(n+1)-1) % return all connected edges
edgeStruct.edgeEnds(neighbors_n,:); % return all connected nodes (need something like unique after this)
